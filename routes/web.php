...
Route::get('dashboard/categories', [CategorieController::class, 'index'])->name('dashboard.categories.indexcat');
Route::post('dashboard/categories', [CategorieController::class, 'store'])->name('dashboard.categories.store');
Route::put('dashboard/categories/{id}', [CategorieController::class, 'update'])->name('dashboard.categories.update');
Route::delete('dashboard/categories/{id}', [CategorieController::class, 'destroy'])->name('dashboard.categories.destroy');