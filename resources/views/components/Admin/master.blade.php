        ...
        <div class="dashboard-nav">
            ...
            <nav class="dashboard-nav-list">
                ...
                <div class='dashboard-nav-dropdown'><a href="#!"
                        ...
                        Menu </a>
                    <div class='dashboard-nav-dropdown-menu'>
                        <a href="{{ route('dashboard.menu.index') }}" class="dashboard-nav-dropdown-item {{ Route::currentRouteNamed('dashboard.menu.index') ? 'activee' : '' }}">Liste des plats</a>
                        <a href="{{ route('dashboard.menu.create') }}" class="dashboard-nav-dropdown-item {{ Route::currentRouteNamed('dashboard.menu.create') ? 'activee' : '' }}">Ajouter plats</a>
                        <a href="{{ route('dashboard.categories.indexcat') }}" class="dashboard-nav-dropdown-item {{ Route::currentRouteNamed('dashboard.menu.create') ? 'activee' : '' }}">Categories Plats</a>
