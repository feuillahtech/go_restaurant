 ...
 <footer class="footer section bd-container">
    <div class="footer__container bd-grid">
        <div class="footer__content">
            <a href="#" class="footer__logo">Nourriture savoureuse</a>
        ...
        <div class="footer__content">
            ...
            <ul>
                <li><a href="#" class="footer__link">Événement</a></li>
        ...
        <div class="footer__content">
            ...
            <ul>
                <li>Thiés</li>
                <li>Diakhao Rte de Base</li>
                <li>78-176-14-35</li>
                <li>feuillahdiatta@gmail.com</li>
            </ul>
        </div>
    </div>

    <p class="footer__copy">&#169; 2024 FeuillahDesigner.Tous droits réservés</p>
</footer>
