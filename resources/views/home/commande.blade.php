...
<body>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="categoriesFood">
                            @if (!count($produits->where('id_categorie', $categorie->id)))
                                <p class="aucunProduit"><i class="fa-solid fa-circle-exclamation"></i> Aucun plat
                                    pour
                    ...
                    <form id="client-form">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-6">
                                ...
                                <input type="tel" class="form-control" name="tel" placeholder="+221 XXXXXXXXX"/>
                            </div>
                        </div>
                        <div class="mb-3">
    ...
    <script>
        ...
        const totalHandler = () => {
            ...
            AfficherTotal.textContent = total + " CFA";
            return total;
        }
        ...
        function passerCommande() {
            if (!products.length) {
                Swal.fire({
                    icon: "error",
                    title: "Veuillez ajouter au moins un plat",
