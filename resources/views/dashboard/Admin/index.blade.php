<x-Admin.master title="Dashboard">
    <h6 class="upcomming mb-4">Accueil</h6>
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-xl-3">
                <div class="card bg-c-green order-card shadow">
                    <div class="card-block">
                        <h6 class="mb-3">Revenue (CFA)</h6>
                        <h2 class="text-right">
                            <h2 class="text-right">
                                <span class="f-left" style="font-style: italic; font-weight: bold;">CFA</span>
                              </h2>
                              
                            <span id="montant-cfa"></span>
                        </h2>
                    </div>
                </div>
            </div>
